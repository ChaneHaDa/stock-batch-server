...
public class AsyncMonthlyStockBatchJobService {
	...
	public AsyncMonthlyStockBatchJobService(JobLauncher jobLauncher,
	 ...
	 */
	@Async("batchTaskExecutor")
	public Future<List<JobExecution>> runMonthlyStockBatchByRange(LocalDate startDate, LocalDate endDate) throws
		Exception {
