...
public class AsyncMonthlyIndexBatchJobService {
	...
	public AsyncMonthlyIndexBatchJobService(JobLauncher jobLauncher,
		@Qualifier("calcIndexPriceJob") Job calcIndexPriceJob) {
	 ...
	 */
	@Async("batchTaskExecutor")
	public Future<List<JobExecution>> runMonthlyIndexBatchByRange(LocalDate startDate, LocalDate endDate) throws
		Exception {
